...
void HojaCalc::insNodo(void)
{
    ...
    do{
        ...
        if(fila >= 1 && fila <= totFil && columna >= 1 && columna <= totCol){
            ...
            cout << "Ubicación no valida para nuevo dato" << endl << endl;
...
int main(void)
{
    ...
    cout << endl;
    cout << "FUNCIONES IMPLEMENTADAS PARA ADMINISTRAR UNA HOJA DE CALCULO" << endl << endl;
    ...
    cout << "Eliminacion de un nodo de la hoja de calculo:" << endl << endl;
    cout << "Digite el nomero de columna del nodo que sera sumado." << endl;
    cout << "Columna: ";
    cin >> fil;

    hojaCalculo.imprimirHojaElec();
    cout << endl;
    hojaCalculo.sumarColumna(fil);
